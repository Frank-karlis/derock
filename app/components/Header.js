...
export default function Header(){
    return(
        <nav className="flex justify-between items-center  bg-[#cbacd6] py-3 px-3 md:px-12 lg:px-16">
            ...
            <div className="flex gap-5 justity-center">
                <Link className="py-3 text-[#433d8b] text-3xs text-bold" href="/page.jsx">Home</Link>
                <Link className="py-3 text-[#433d8b] text-3xs text-bold" href="/https://maps.app.goo.gl/X5UkYMTsRUuRAsF49?g_st=iw">Locate us</Link>
