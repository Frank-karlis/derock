...
export default function Header(){
    ...
    return(
        ...
        <ul className="bg-blue-800 flex flex-col gap-5 p-4 head  z-10" style={{color:"whitesmoke"}}>
            ...
            <li><Link href="#" className="font-bold hover:text-red-800 duration-300 ">Product</Link></li>
            <li><Link href="#" className="font-bold hover:text-red-800 duration-300">Spare Part</Link></li>
