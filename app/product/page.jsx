...
<div>
          ...
          <div className="">
<h3 className="mt-2 text-2xl text-center font-medium text-white md:text-4xl lg:text-4xl"><span className="text-red-900">NOTE:</span><u>PLEASE NOTE THAT THE PRICES ARE NOT FIXED AND THEY ARE NOGOTIABLE</u></h3>
          </div>
</section>
        </main>
    )
